    ...
    async def execute(
        ...
        *,
        ...
        async def _run_subprocess() -> None:
            ...
            # Inject MCP server config into .gemini/settings.json at the
            # git root (which is how the Gemini CLI resolves projects).
            ...
            try:
                ...
                # Restore or remove the injected .gemini/settings.json
                try:
